...
export class ScheduleService {
  ...
  protected convertDateFromClient(schedule: ISchedule): ISchedule {
    const copy: ISchedule = Object.assign({}, schedule, {
      startHour: schedule.startHour && schedule.startHour.isValid() ? schedule.startHour.toJSON() : undefined,
      endHour: schedule.endHour && schedule.endHour.isValid() ? schedule.endHour.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.startHour = res.body.startHour ? moment(res.body.startHour) : undefined;
      res.body.endHour = res.body.endHour ? moment(res.body.endHour) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((schedule: ISchedule) => {
        schedule.startHour = schedule.startHour ? moment(schedule.startHour) : undefined;
        schedule.endHour = schedule.endHour ? moment(schedule.endHour) : undefined;
      });
    }
    return res;
  }
