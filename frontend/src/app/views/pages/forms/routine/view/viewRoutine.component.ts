...
export class ViewRoutineComponent implements OnInit {
    ...
    constructor(private modalService: NgbModal, private exerciseService: ExerciseService, private router: Router, private routineService: RoutineService, private exercisesSetService: ExercisesSetService, private exercisesSetTypeService: ExercisesSetTypeService,
